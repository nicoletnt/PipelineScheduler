            ...
            if (!needsScheduling) {
                ...
                if (currentAssignment != null) {
                  ...
                  //Set the sets of executors to be placed in each slot (we have two slots per supervisor)
                   ...
                   ExecutorsOfAntiparos1.add(componentToExecutors.get("exclaim2").get(3));
                   ExecutorsOfAntiparos1.add(componentToExecutors.get("dummy").get(4));
                   ExecutorsOfAntiparos1.add(componentToExecutors.get("word").get(5));
                   ExecutorsOfAntiparos1.add(componentToExecutors.get("__acker").get(3));
                   
                   ExecutorsOfAntiparos2.add(componentToExecutors.get("exclaim1").get(0));
                   ExecutorsOfAntiparos2.add(componentToExecutors.get("word").get(1));
                   ExecutorsOfAntiparos2.add(componentToExecutors.get("dummy").get(2));
                   ExecutorsOfAntiparos2.add(componentToExecutors.get("__acker").get(2));                 
                   ...
                   ExecutorsOfFolegandros1.add(componentToExecutors.get("exclaim1").get(3));
                   ExecutorsOfFolegandros1.add(componentToExecutors.get("dummy").get(5));
                   ExecutorsOfFolegandros1.add(componentToExecutors.get("dummy").get(8));
                   ExecutorsOfFolegandros1.add(componentToExecutors.get("__acker").get(5));
                   
                   ExecutorsOfFolegandros2.add(componentToExecutors.get("exclaim2").get(0));
                   ExecutorsOfFolegandros2.add(componentToExecutors.get("dummy").get(1));
                   ExecutorsOfFolegandros2.add(componentToExecutors.get("word").get(2));
                   ExecutorsOfFolegandros2.add(componentToExecutors.get("__acker").get(4));
